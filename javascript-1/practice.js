...
var total = myNumbers.reduce( (startingPoint, val) => startingPoint + val, 0 );
...
myNumbers.forEach( (_, i) => myNumbersIndex.push(i) );
...
var forTheLoveOfGeorge = notGeorge.map( () => 'George' );
...
var enemies = people.filter( val => val.friend == false ? true : false );
...
var totallyAwesome = people.reduce( (howAwesome, val) => howAwesome + val.awesomeLevel , 0);
